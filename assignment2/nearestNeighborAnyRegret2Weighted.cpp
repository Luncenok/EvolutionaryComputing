...
std::vector<int> nearestNeighborAnyRegret2Weighted(int startNode, int selectCount, const std::vector<std::vector<int>>& distance, const std::vector<int>& costs, double wRegret, double wBest) {
